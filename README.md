...
You can see a live preview here: <a href='http://clients.niklausgerber.com/rapid-bootstrap-v5/' title='Rapid Bootstrap V5 Live Preview' target='_blank'>Rapid Bootstrap V5 Live Preview</a>
...
Please support humans.txt (http://humanstxt.org/). It's an initiative for knowing the people behind a website. It's a TXT file that contains information about the different people who have contributed to building the website.
	...
	Rapid Bootstrap: https://github.com/niklausgerber/rapid-bootstrap-v5
	Niklaus Gerber
